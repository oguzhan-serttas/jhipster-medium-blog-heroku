...
class CommentResourceIT {
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().comment(DEFAULT_COMMENT).createdAt(DEFAULT_CREATED_AT).updatedAt(DEFAULT_UPDATED_AT);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().comment(UPDATED_COMMENT).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
        return comment;
    }
    ...
    void putNewComment() throws Exception {
        ...
        updatedComment.comment(UPDATED_COMMENT).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.comment(UPDATED_COMMENT).updatedAt(UPDATED_UPDATED_AT);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.comment(UPDATED_COMMENT).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
