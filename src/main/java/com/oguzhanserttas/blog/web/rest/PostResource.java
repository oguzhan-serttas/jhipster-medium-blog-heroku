...
/**
 * REST controller for managing {@link com.oguzhanserttas.blog.domain.Post}.
 */
@RestController
@RequestMapping("/api")
public class PostResource {
    ...
    public PostResource(PostService postService, PostRepository postRepository, PostIntegration postIntegration) {
