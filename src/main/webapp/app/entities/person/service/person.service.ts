...
type RestOf<T extends IPerson | NewPerson> = Omit<T, 'createdAt' | 'updatedAt'> & {
...
export class PersonService {
  ...
  protected convertDateFromClient<T extends IPerson | NewPerson | PartialUpdatePerson>(person: T): RestOf<T> {
    return {
      ...person,
      createdAt: person.createdAt?.toJSON() ?? null,
      updatedAt: person.updatedAt?.toJSON() ?? null,
    };
  }
  ...
  protected convertDateFromServer(restPerson: RestPerson): IPerson {
    return {
      ...restPerson,
      createdAt: restPerson.createdAt ? dayjs(restPerson.createdAt) : undefined,
      updatedAt: restPerson.updatedAt ? dayjs(restPerson.updatedAt) : undefined,
    };
  }
